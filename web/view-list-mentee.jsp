<%-- 
    Document   : view-list-student
    Created on : Dec 3, 2024, 4:11:41 PM
    Author     : Admin
--%>
	...
	<div class="offcanvas offcanvas-start flex-row custom-scrollbar h-100" data-bs-backdrop="true" tabindex="-1" id="offcanvasSidebar">
		<div class="offcanvas-body sidebar-content d-flex flex-column bg-dark">
			...
			<ul class="navbar-nav flex-column" id="navbar-sidebar">
				...
				<!-- Menu item 3 -->
				<li class="nav-item"> <a class="nav-link active" href="view-list-mentee.jsp"><i class="fas fa-user-graduate fa-fw me-2"></i>Mentee</a></li>
...
<div class="page-content">
	...
	<div class="page-content-wrapper border">
		...
		<div class="row">
			<div class="col-12">
				<h1 class="h3 mb-2 mb-sm-0">Mentee</h1>
			</div>
		</div>
...
<!-- Mirrored from eduport.webestica.com/admin-student-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jan 2022 19:21:11 GMT -->
</html>